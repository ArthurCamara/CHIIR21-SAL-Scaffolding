...
def generate_index():
    ...
    data_dir = os.path.join(os.path.join(config.data_home, "docs/wikipedia_paragaphs.trec"))
    index_path = os.path.join(os.path.join(config.data_home, "indexes/wikipedia_paragraphs"))
